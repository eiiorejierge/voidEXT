...
test('admin controls, announcements, and support conversations work end to end', async () => {
  ...
  assert.equal(builtInReleases.json.releases.some((item) => item.version === '2.9.6'), true);
  assert.equal(builtInReleases.json.releases.some((item) => item.version === '2.9.5'), true);
  assert.equal(builtInReleases.json.releases.some((item) => item.version === '2.9.4'), true);
