...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .instruction{display:block;margin-top:14px;padding:12px 14px;border-left:2px solid #c084fc;background:rgba(192,132,252,.08);color:rgba(255,255,255,.68);font-size:12px;line-height:1.65;text-align:left}
  .instruction strong{color:#fff;letter-spacing:.01em}
