...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .signin{display:inline-flex;margin-top:14px;padding:10px 14px;border:1px solid #c084fc;background:rgba(192,132,252,.1);color:#fff!important;font-weight:700;text-decoration:none!important;transition:background .15s,color .15s}
  .signin:hover{background:#c084fc;color:#0b0612!important}
  .next{display:block;margin-top:9px;color:rgba(255,255,255,.48);font-size:11px}
...
(function(){
  ...
  if(!session){
    return fail('You must be logged in to <strong>nebulabkmlinks.shop</strong> in this browser to open this private link.<br><a class="signin" href="/app.html" target="_blank" rel="noopener">Sign in to Scale XT</a><small class="next">Then return here and refresh.</small>');
  }
  fetch('/api/frame-ticket',{
    ...
    var m=e&&e.message;
    if(m==='signin') return fail('Your <strong>nebulabkmlinks.shop</strong> login has expired.<br><a class="signin" href="/app.html" target="_blank" rel="noopener">Sign in again</a><small class="next">Then return here and refresh.</small>');
